...
#define INPUT_FILEPATH1 "../input_data/displayDriver_input_test_alarm_set.txt"
#define INPUT_FILEPATH2 "../input_data/displayDriver_input_test_alarm_time.txt"
#define INPUT_FILEPATH3 "../input_data/displayDriver_input_test_time_of_day.txt"
#define OUTPUT_FILEPATH "../simulation_results/displayDriver_test_output_messages.txt"
...
int main(){
    ...
    const char * i_input_data_alarm_time = INPUT_FILEPATH2;
    ...
    const char * i_input_data_time_of_day = INPUT_FILEPATH3;
    ...
    oports_TOP = {typeid(displayed_time)};
    dynamic::modeling::Models submodels_TOP;
    submodels_TOP = {input_reader_alarm_set, input_reader_alarm_time, input_reader_time_of_day, displayDriver1};
    ...
    ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,DispDrv_defs::alarm_set>("input_reader_alarm_set","displayDriver1"),
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,DispDrv_defs::alarm_time>("input_reader_alarm_time","displayDriver1"),
        dynamic::translate::make_IC<iestream_input_defs<int>::out,DispDrv_defs::time_of_day>("input_reader_time_of_day","displayDriver1")
    ...
    static ofstream out_state("../simulation_results/displayDriver_test_output_state.txt");
    ...
    cout<<"Display Driver Model Run Successful."<<"\n";
