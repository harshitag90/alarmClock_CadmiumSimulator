...
#define INPUT_FILEPATH1 "../input_data/alarm_input_test_alarm_set.txt"
#define INPUT_FILEPATH2 "../input_data/alarm_input_test_hour.txt"
#define INPUT_FILEPATH3 "../input_data/alarm_input_test_minutes.txt"
#define OUTPUT_FILEPATH "../simulation_results/alarm_test_output_messages.txt"
...
int main(){
    ...
    const char * i_input_data_alarm_set = INPUT_FILEPATH1;
    ...
    const char * i_input_data_hours = INPUT_FILEPATH2;
    ...
    /****** Input Reader for MINUTES atomic model instantiation *******************/
    const char * i_input_data_minutes = INPUT_FILEPATH3;
    shared_ptr<dynamic::modeling::model> input_reader_minutes;
    input_reader_minutes = dynamic::translate::make_dynamic_atomic_model<InputReader_Message_t, TIME, const char*>("input_reader_minutes", move(i_input_data_minutes));
    ...
    oports_TOP = {typeid(alarm_time)};
    dynamic::modeling::Models submodels_TOP;
    submodels_TOP = {input_reader_alarm_set, input_reader_hours, input_reader_minutes, alarmRegister1};
    ...
    ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,AlarmReg_defs::alarm_set>("input_reader_alarm_set","alarmRegister1"),
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,AlarmReg_defs::hours>("input_reader_hours","alarmRegister1"),
        dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,AlarmReg_defs::minutes>("input_reader_minutes","alarmRegister1")
    ...
    static ofstream out_state("../simulation_results/alarm_test_output_state.txt");
    ...
    cout<<"Alarm Register Model Run Successful."<<"\n";
